...
class __$$IncrementCopyWithImpl<$Res>
    extends _$Counter2EventCopyWithImpl<$Res, _$Increment>
...
class _$Increment implements Increment {
  ...
  @override
  String toString() {
    return 'Counter2Event.increment()';
  }
...
abstract class Increment implements Counter2Event {
...
class __$$DecrementCopyWithImpl<$Res>
    extends _$Counter2EventCopyWithImpl<$Res, _$Decrement>
...
class _$Decrement implements Decrement {
  ...
  @override
  String toString() {
    return 'Counter2Event.decrement()';
  }
...
abstract class Decrement implements Counter2Event {
...
class _$_Counter2State implements _Counter2State {
  const _$_Counter2State({required this.count});
  ...
  @override
  String toString() {
    return 'Counter2State(count: $count)';
  }
...
abstract class _Counter2State implements Counter2State {
  const factory _Counter2State({required final int count}) = _$_Counter2State;
